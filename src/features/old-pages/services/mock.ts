...
export const destoryInfo: DestoryInfo = {
  ...
  payment: [
    ...
    { id: 2, name: 'NADI+AUS', icon: '', type: 'nadi', pay_type: 2, extend: { primary_system_currency_id: 2, secondary_system_currency_id: 5 } },
  ],
...
const miningLogs: MiningLogItem[] = Array.from({ length: 20 }, (_, i) => ({
  ...
  type: i % 3 === 2 ? 2 : 1,
  cate: (i % 6) + 1,
  total: String((Math.random() * 100).toFixed(6)),
  msg: ['购买矿机', '购买节点', '提现', '冻结算力', '解锁算力', '联合挖矿'][i % 6],
  content: `算力日志记录 #${i + 1}`,
...
export const withdrawConfigData: WithdrawConfigData = {
  ...
  usdt_mine_config: {
    ...
    day_list: [
      { id: 1, day: 1, fee_rate: '20' },
      { id: 2, day: 10, fee_rate: '15' },
      { id: 3, day: 20, fee_rate: '10' },
      { id: 4, day: 30, fee_rate: '5' },
      { id: 5, day: 40, fee_rate: '0' },
    ],
  },
}

export const withdrawRecordList: WithdrawRecordItem[] = [
  {
    id: 15,
...
export const withdrawMinerDetailList: WithdrawMinerDetailItem[] = [
  {
    id: 11,
    wid: 14,
    user_id: 61,

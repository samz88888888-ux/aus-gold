...
type OldPagesCopy = {
  ...
  ausReleaseDetails: string
  orderNo: string
  actualReceived: string
  ausTotal: string
  noReleaseDetails: string
...
const oldPagesCopyByLanguage: Record<LanguageCode, OldPagesCopy> = {
  'zh-TW': {
    ...
    destroyMiningDescription:
      '輸入 USDC 金額後自動換算支付幣種，建立待支付訂單後前往完成鏈上或餘額支付。',
    ...
    withdrawSubmitted: 'USDC 提現申請已提交',
    ...
    ausReleaseDetails: 'AUS 釋放明細',
    orderNo: '訂單號',
    actualReceived: '實際到賬',
    ausTotal: 'AUS 總量',
    noReleaseDetails: '暫無釋放明細',
    autoReleaseLabel: '自動釋放 #{{index}}',
    usdcAmount: 'USDC 數量',
    ausReceived: '到賬 AUS',
    ausFee: 'AUS 手續費',
    requested: '申請數量',
    ...
    availableUsdtMining: '可用 股權算力',
    withdrawToken: '提現幣種',
    switchAction: '切換',
    withdrawAmount: '提現數量',
    withdrawLimit: '限額 {{min}} - {{max}} {{coin}}',
    enterUsdtAmount: '輸入 USDC 數量',
    enterUsdtMiningAmount: '輸入 股權算力數量',
    allCaps: '全部',
    ...
    daysUnit: '天',
    feeLabel: '手續費',
    estimatedUsdt: '預計到賬 USDC',
    estimatedAusTotal: '預計到賬 AUS 總量',
    estimatedDailyAus: '預計每日到賬 AUS',
    priceLabel: '價格',
    feeRateLabel: '手續費率',
    convertedAus: '兌換 AUS',
    submitUsdtWithdraw: '提交 USDC 提現',
    submitUsdtMiningWithdraw: '提交 股權算力提現',
  ...
  en: {
    ...
    inputUsdtAmount: 'Enter USDC amount',
    ...
    destroyMiningDescription:
      'Enter a USDC amount to auto-convert the payment token, then create a pending order and complete on-chain or balance payment.',
    ...
    withdrawSubmitted: 'USDC withdrawal request submitted',
    withdrawMiningSubmitted:
    ...
    ausReleaseDetails: 'AUS Release Details',
    orderNo: 'Order No.',
    actualReceived: 'Actual Received',
    ausTotal: 'AUS Total',
    noReleaseDetails: 'No release details',
    autoReleaseLabel: 'Auto release #{{index}}',
    usdcAmount: 'USDC Amount',
    ausReceived: 'AUS Received',
    ausFee: 'AUS Fee',
    requested: 'Requested',
    ...
    availableUsdtMining: 'Available USDC Mining',
    withdrawToken: 'Withdraw Token',
    switchAction: 'Switch',
    withdrawAmount: 'Withdraw Amount',
    withdrawLimit: 'Limit {{min}} - {{max}} {{coin}}',
    enterUsdtAmount: 'Enter USDC amount',
    enterUsdtMiningAmount: 'Enter USDC Mining amount',
    allCaps: 'All',
    ...
    submitUsdtWithdraw: 'Submit USDC Withdraw',
    submitUsdtMiningWithdraw: 'Submit USDC Mining Withdraw',
  ...
  ko: {
    ...
    quickAction: '빠른 작업',
    destroyMiningDescription:
      'USDC 금액을 입력하면 결제 토큰이 자동 환산되며, 미결제 주문 생성 후 온체인 또는 잔액 결제를 완료할 수 있습니다.',
    ...
    withdrawSubmitted: 'USDC 출금 신청이 제출되었습니다',
    withdrawMiningSubmitted:
      'USDC 채굴 출금 신청이 제출되었습니다. 기록에서 일별 입금 상세를 확인할 수 있습니다.',
    viewRecords: '기록 보기',
    viewAusDetails: 'AUS 상세 보기',
    withdrawBadge: '출금',
    withdrawDetails: '출금 상세',
    ausReleaseDetails: 'AUS 지급 상세',
    orderNo: '주문번호',
    actualReceived: '실제 입금',
    ausTotal: 'AUS 총량',
    noReleaseDetails: '지급 상세가 없습니다',
    autoReleaseLabel: '자동 지급 #{{index}}',
    usdcAmount: 'USDC 수량',
    ausReceived: 'AUS 수령량',
    ausFee: 'AUS 수수료',
    requested: '신청 수량',
    ...
    availableUsdtMining: '사용 가능 USDC 채굴',
    withdrawToken: '출금 코인',
    switchAction: '전환',
    withdrawAmount: '출금 수량',
    withdrawLimit: '한도 {{min}} - {{max}} {{coin}}',
    enterUsdtAmount: 'USDC 수량 입력',
    enterUsdtMiningAmount: 'USDC 채굴 수량 입력',
    allCaps: '전체',
    ...
    daysUnit: '일',
    feeLabel: '수수료',
    estimatedUsdt: '예상 수령 USDC',
    estimatedAusTotal: '예상 AUS 총액',
    estimatedDailyAus: '예상 일일 AUS',
    priceLabel: '가격',
    feeRateLabel: '수수료율',
    convertedAus: '환산 AUS',
    submitUsdtWithdraw: 'USDC 출금 제출',
    submitUsdtMiningWithdraw: 'USDC 채굴 출금 제출',
  ...
  ja: {
    ...
    quickAction: 'クイック操作',
    destroyMiningDescription:
      'USDC 金額を入力すると支払いトークンが自動換算され、未払い注文作成後にオンチェーンまたは残高支払いを完了できます。',
    ...
    withdrawSubmitted: 'USDC 出金申請が送信されました',
    withdrawMiningSubmitted:
    ...
    ausReleaseDetails: 'AUS 解放明細',
    orderNo: '注文番号',
    actualReceived: '実際到着',
    ausTotal: 'AUS 総量',
    noReleaseDetails: '解放明細がありません',
    autoReleaseLabel: '自動解放 #{{index}}',
    usdcAmount: 'USDC 数量',
    ausReceived: '到着 AUS',
    ausFee: 'AUS 手数料',
    requested: '申請数量',
    ...
    availableUsdtMining: '利用可能 USDC マイニング',
    withdrawToken: '出金通貨',
    switchAction: '切替',
    withdrawAmount: '出金数量',
    withdrawLimit: '上限 {{min}} - {{max}} {{coin}}',
    enterUsdtAmount: 'USDC 数量を入力',
    enterUsdtMiningAmount: 'USDC マイニング数量を入力',
    allCaps: 'すべて',
    ...
    daysUnit: '日',
    feeLabel: '手数料',
    estimatedUsdt: '予想到着 USDC',
    estimatedAusTotal: '予想到着 AUS 総量',
    estimatedDailyAus: '予想日次 AUS',
    priceLabel: '価格',
    feeRateLabel: '手数料率',
    convertedAus: '換算 AUS',
    submitUsdtWithdraw: 'USDC 出金を送信',
    submitUsdtMiningWithdraw: 'USDC マイニング出金を送信',
  ...
  th: {
    ...
    inputUsdtAmount: 'กรอกจำนวน USDC',
    ...
    destroyMiningDescription:
      'กรอกจำนวน USDC แล้วระบบจะคำนวณโทเค็นที่ต้องชำระอัตโนมัติ จากนั้นสร้างคำสั่งซื้อค้างชำระเพื่อไปชำระบนเชนหรือด้วยยอดคงเหลือ',
    ...
    withdrawSubmitted: 'ส่งคำขอถอน USDC แล้ว',
    withdrawMiningSubmitted:
    ...
    ausReleaseDetails: 'รายละเอียดการปล่อย AUS',
    orderNo: 'เลขที่คำสั่งซื้อ',
    actualReceived: 'รับจริง',
    ausTotal: 'AUS รวม',
    noReleaseDetails: 'ไม่มีรายละเอียดการปล่อย',
    autoReleaseLabel: 'ปล่อยอัตโนมัติ #{{index}}',
    usdcAmount: 'จำนวน USDC',
    ausReceived: 'AUS ที่ได้รับ',
    ausFee: 'ค่าธรรมเนียม AUS',
    requested: 'จำนวนที่ขอถอน',
    receivedToken: 'เหรียญที่ได้รับ',
    ...
    availableUsdtMining: 'USDC Mining ที่ใช้ได้',
    withdrawToken: 'เหรียญที่ถอน',
    switchAction: 'สลับ',
    withdrawAmount: 'จำนวนถอน',
    withdrawLimit: 'วงเงิน {{min}} - {{max}} {{coin}}',
    enterUsdtAmount: 'กรอกจำนวน USDC',
    enterUsdtMiningAmount: 'กรอกจำนวน USDC Mining',
    allCaps: 'ทั้งหมด',
    ...
    estimatedUsdt: 'USDC ที่คาดว่าจะได้รับ',
    ...
    submitUsdtWithdraw: 'ส่งถอน USDC',
    submitUsdtMiningWithdraw: 'ส่งถอน USDC Mining',
  ...
  ms: {
    ...
    inputUsdtAmount: 'Masukkan jumlah USDC',
    ...
    destroyMiningDescription:
      'Masukkan jumlah USDC dan token bayaran akan ditukar secara automatik, kemudian cipta pesanan belum bayar untuk diselesaikan melalui on-chain atau baki.',
    ...
    withdrawSubmitted: 'Permohonan pengeluaran USDC telah dihantar',
    withdrawMiningSubmitted:
    ...
    withdrawBadge: 'Pengeluaran',
    withdrawDetails: 'Butiran Pengeluaran',
    ausReleaseDetails: 'Butiran Pelepasan AUS',
    orderNo: 'No. Pesanan',
    actualReceived: 'Jumlah Diterima',
    ausTotal: 'Jumlah AUS',
    noReleaseDetails: 'Tiada butiran pelepasan',
    autoReleaseLabel: 'Lepasan automatik #{{index}}',
    usdcAmount: 'Jumlah USDC',
    ausReceived: 'AUS Diterima',
    ausFee: 'Yuran AUS',
    requested: 'Jumlah Dimohon',
    ...
    availableUsdt: 'USDC Tersedia',
    availableUsdtMining: 'USDC Mining Tersedia',
    withdrawToken: 'Token Pengeluaran',
    switchAction: 'Tukar',
    withdrawAmount: 'Jumlah Pengeluaran',
    withdrawLimit: 'Had {{min}} - {{max}} {{coin}}',
    enterUsdtAmount: 'Masukkan jumlah USDC',
    enterUsdtMiningAmount: 'Masukkan jumlah USDC Mining',
    allCaps: 'Semua',
    ...
    daysUnit: 'hari',
    feeLabel: 'Yuran',
    estimatedUsdt: 'USDC Dijangka Diterima',
    ...
    submitUsdtWithdraw: 'Hantar Pengeluaran USDC',
    submitUsdtMiningWithdraw: 'Hantar Pengeluaran USDC Mining',
